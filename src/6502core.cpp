...
# define LUDO_DEBUG \
  ...
  psp_sdl_fill_print(10, 20, buffer, psp_sdl_rgb(0xff, 0xff, 0xff), psp_sdl_rgb(0x00,0x00,0x00)); \
  psp_sdl_flip(); \
  } 
# endif

#include "z80_support.cpp"
#include "z80.cpp"

void 
Exec6502Instruction(void) 
{
...
# if 0 //LUDO:
    fprintf(stdout, "pc=%x ins=%x\n", ProgramCounter-1, CurrentInstruction);
# endif
# if 0 //LUDO:
    {
      char buffer[128];
      sprintf(buffer, "pc=%x ins=%x", ProgramCounter-1, CurrentInstruction);
      psp_sdl_fill_print(10, 10, buffer, psp_sdl_rgb(0xff, 0xff, 0xff), psp_sdl_rgb(0x00,0x00,0x00));
      psp_sdl_flip();
    }
# endif
		//std::cout << "Fetch at " << (ProgramCounter-1) << " giving " << CurrentInstruction << "\n"; 
